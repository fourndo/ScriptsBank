...
plot([-0.05 -0.05],[-0.1 1]*10^-1,'k--')
plot([-0.05 0.05],[1 1]*10^-1,'k--')
plot([0.05 0.05],[-0.1 1]*10^-1,'k--')
plot([-0.05 0.05],[-0.1 -0.1]*10^-1,'k--')

ylim([-5e-2 1.05]);
ylabel('$\rho(x)$', 'interpreter', 'latex','FontSize',14)
...
xlabel('$\mathbf{x}(m)$', 'interpreter', 'latex','FontSize',14)
set(ylabh,'Position',get(ylabh,'Position') - [0.001 0.0 0.00]);
% axis square
...
yy = get(gca,'Ylim');
plot([1e-2 1e-2],yy,'r-.')
ylabel('$\mathbf{r}(x)$', 'interpreter', 'latex','FontSize',16)
set(get(gca,'YLabel'),'Rotation',360);
ylabh = get(gca,'YLabel');
set(ylabh,'Position',get(ylabh,'Position') - [0.01 0 0]);
xlabel('$\mathbf{x}(m)$', 'interpreter', 'latex','FontSize',14)
text(.108,0.075,'(b)', 'interpreter', 'latex','FontSize',14);
...
yy = get(gca,'Ylim');
plot([10^(-2) 10^(-2)],yy,'r-.')
ylabel('$\mathbf{g}(x)$', 'interpreter', 'latex','FontSize',16)
set(get(gca,'YLabel'),'Rotation',360);
ylabh = get(gca,'YLabel');
set(ylabh,'Position',get(ylabh,'Position') - [0.01 0 0]);
xlabel('$\mathbf{x}(m)$', 'interpreter', 'latex','FontSize',14)
text(.108,1e-4,'(c)', 'interpreter', 'latex','FontSize',14);
...
yy = get(gca,'Ylim');
plot([10^(-2) 10^(-2)],yy,'r-.')
ylabel('$\mathbf{\hat g}(x)$', 'interpreter', 'latex','FontSize',16)
set(get(gca,'YLabel'),'Rotation',360);
ylabh = get(gca,'YLabel');
set(ylabh,'Position',get(ylabh,'Position') - [0.01 0 0]);
xlabel('$\mathbf{x}(m)$', 'interpreter', 'latex','FontSize',14)
