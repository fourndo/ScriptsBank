...
% Gradient g-y-z
g18 = T;
g18( ind( val ~=-210 & val ~= 10 ) ) = 0;
g18( ind( val ==-210 )) = 1;
g18(ind( val ==10 ) ) = -1;

% Remove nullcells
g18 = g18(nullcell==1,nullcell==1);

% Gradient g-y-z
g19 = T;
g19( ind( val ~=-150 & val ~= 10 ) ) = 0;
g19( ind( val ==-150 )) = 1;
g19(ind( val ==10 ) ) = -1;

% Remove nullcells
g19 = g19(nullcell==1,nullcell==1);

% Gradient g-y-z
g20 = T;
g20( ind( val ~=-90 & val ~= 10 ) ) = 0;
g20( ind( val ==-90 )) = 1;
g20(ind( val ==10 ) ) = -1;

% Remove nullcells
g20 = g20(nullcell==1,nullcell==1);

% Gradient g-y-z
g21 = T;
g21( ind( val ~=21 & val ~= 10 ) ) = 0;
g21( ind( val ==21 )) = 1;
g21(ind( val ==10 ) ) = -1;

% Remove nullcells
g21 = g21(nullcell==1,nullcell==1);

% Gradient g-y-z
g22 = T;
g22( ind( val ~=15 & val ~= 10 ) ) = 0;
g22( ind( val ==15 )) = 1;
g22(ind( val ==10 ) ) = -1;

% Remove nullcells
g22 = g22(nullcell==1,nullcell==1);

% Gradient g-y-z
g23 = T;
g23( ind( val ~=9 & val ~= 10 ) ) = 0;
g23( ind( val ==9 )) = 1;
g23(ind( val ==10 ) ) = -1;

% Remove nullcells
g23 = g23(nullcell==1,nullcell==1);

% Gradient g-y-z
g24 = T;
g24( ind( val ~=210 & val ~= 10 ) ) = 0;
g24( ind( val ==210 )) = 1;
g24(ind( val ==10 ) ) = -1;

% Remove nullcells
g24 = g24(nullcell==1,nullcell==1);

% Gradient g-y-z
g25 = T;
g25( ind( val ~=150 & val ~= 10 ) ) = 0;
g25( ind( val ==150 )) = 1;
g25(ind( val ==10 ) ) = -1;

% Remove nullcells
g25 = g25(nullcell==1,nullcell==1);

% Gradient g-y-z
g26 = T;
g26( ind( val ~=90 & val ~= 10 ) ) = 0;
g26( ind( val ==90 )) = 1;
g26(ind( val ==10 ) ) = -1;

% Remove nullcells
g26 = g26(nullcell==1,nullcell==1);
...
G{23} = g23;G{24} = g24;G{25} = g25;G{26} = g26;
