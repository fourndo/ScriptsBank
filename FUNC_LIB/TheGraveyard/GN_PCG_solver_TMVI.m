function [m, tncg, Pac] = GN_PCG_solver_TMVI( G, m, mref, nullcell, d, phi_in, beta , PreC, Pac, lowBvec, uppBvec , MOF, aVRWs, aVRWx, aVRWy, aVRWz, FLAG )
...
while solves < 10 && rddm > 1e-3
    ...
    while (phi_out(1) > phi_in || gamma == 2) && phi_out(2)/phi_out(1) >= 1
