...
cd Shredit
fid2=fopen('3893_Goldstrike_inter.dat','w');
...
while 1
    ...
    if line==-1
        ...
        if test_freq_match==1 | test_freq_match2==1
            ...
            %get site data
            block=[];
            for k=1:10  %number of blocks per site for this type of data
                subblock=[];  j=[];
            ...
            for jj=1:size(all_data,1)
                fprintf(fid2,'%s %d %12.10e %12.10e %12.10e %12.10e %12.10e %12.10e %12.10e %12.10e %12.10e\n',...
                    line_num,stn_num,all_data(jj,1),all_data(jj,3),all_data(jj,4),all_data(jj,5),all_data(jj,6),...
                    all_data(jj,7),all_data(jj,8),all_data(jj,9),all_data(jj,10))
            end
