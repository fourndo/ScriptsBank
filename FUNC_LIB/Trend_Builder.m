...
% INPUT VARIABLES
work_dir = 'C:\LC\Private\dominiquef\Projects\4414_Minsim\Modeling\GRAV';

% meshfile = '..\Mesh_50m_padded.msh';

obsfile = 'Grav_Trout.dat';
% fwrfile = '..\Aug1995\FWR_SPEC_95_Grid50m_Drapped_100m_RTP.mag';
outfile = 'Grav_Trout_DeTrend_local.dat';
...
[Obsx, Obsy, Obsz, obs, wd_full] = read_GRAV3D_obs([work_dir dsep obsfile]);
% [H, BI, BD, MI, MD, Obsx, Obsy, Obsz, obs, wd_full] = read_MAG3D_obs([work_dir dsep obsfile]);
%[H, BI, BD, MI, MD, Obsx, Obsy, Obsz, fwr, wd_full] = read_MAG3D_obs([work_dir dsep fwrfile]);
...
write_GRAV3D_obs([work_dir dsep outfile],Obsx,Obsy,Obsz,d_detrend,wd_full)
