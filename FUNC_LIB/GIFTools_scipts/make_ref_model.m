...
work_dir = 'C:\Users\dominiquef.MIRAGEOSCIENCE\Google Drive\Tli_Kwi_Cho\Modelling\Inversion\EM\DIGHEM\3D\Tile_DO27_DO18\Coarse';
...
zmax = 432;
% 
selector = (XYZ(:,3) > zmin) & (XYZ(:,3) < zmax);      
model(selector) = 1e-3;

m.setValue(model);
% Save weights
m.writeFile([work_dir '\ref_10m_1em3.dat']);
