...
for ll in range(size(lvec)):
    ...
    for pp in range(size(pvec)):
        ...
        for qq in range(size(qvec)):
            ...
            shutil.copy(UBC_dir + 'gzinv3d_00' + str(iter_start) + '.den', Work_dir)
            ...
            model = loadtxt(Work_dir + 'gzinv3d_00' + str(iter_start) + '.den')
    ...
    ## Inversion iterations
            ...
            while (oo<= iter_max ) & (phid >= ndata*chifact):
                ...
                os.system('gzinv3d_newbounds lp_ctrl_file.inp')
                ...
                if phid ==99999:
                    ...
                    print ('cp gzinv3d_001.den '+ new_dir + 'gzinv3d_0'+str(oo)+'.den')
                    os.system('cp gzinv3d_001.den '+ new_dir + 'gzinv3d_0'+str(oo)+'.den')
                    os.system('cp gzinv3d_001.pre '+ new_dir + 'gzinv3d_0'+str(oo)+'.pre')
                    os.system('cp gzinv3d.log '+ new_dir + 'gzinv3d_0'+str(oo)+'.log')
                
                    model = loadtxt(Work_dir + 'gzinv3d_0' + strnum + '.den')
