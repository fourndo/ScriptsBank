function [Tx,Ty,Tz] = MAGSEN_Func(work_dir,dsep,xn,yn,zn, H, BI, BD, MI, MD, dtype, obsx, obsy, obsz,nullcell, wr_flag, sen_flag, R, R0)
...
fprintf(['Begin Sensitivity Calculation\n'])
progress = -1;
tic 
