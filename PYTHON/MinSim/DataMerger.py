...
local_dir = {'MAG':'FWR_MAG\\Complex\\',
             ...
             'Gxy':'FWR_GG\Simple\FWR_Gxy\\',
             'Gxz':'FWR_GG\Simple\FWR_Gxz\\',
             'Gyy':'FWR_GG\Simple\FWR_Gyy\\',
             'Gyz':'FWR_GG\Simple\FWR_Gyz\\',
             'Gzz':'FWR_GG\Simple\FWR_Gzz\\'}
...
meshfile = 'C:\\LC\\Private\\dominiquef\\Projects\\4414_Minsim\\Modeling\\Forward\\Mesh_20m.msh'
...
#    dataGrid /= 0.91
    ...
    plt.contourf(gCx,gCy,dataGrid.T,100, cmap = 'magma', vmin=vmin, vmax=vmax)
    plt.clim(vmin,vmax)
    plt.xlim(xmin,xmax)
    plt.ylim(ymin,ymax)
...
#%% Deal with TDEM data
    ...
    for pp in range(AllData.shape[1]):
        ...
        p = plt.contourf(gCx,gCy,np.log10(data),100, cmap='magma_r')
