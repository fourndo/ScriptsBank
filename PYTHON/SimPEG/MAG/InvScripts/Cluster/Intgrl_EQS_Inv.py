...
Mesh.TensorMesh.writeUBC(mesh, work_dir + out_dir + driver.mshfile)
...
Mesh.TensorMesh.writeModelUBC(mesh, work_dir + out_dir + "EQS_Model.sus", surfMap*mrec)
...
# Mesh.TensorMesh.writeModelUBC(mesh, work_dir + out_dir + tile_dirl2 + "AMP_Tile" + str(tt) + ".sus", actvMap*reg.l2model)
# Mesh.TensorMesh.writeModelUBC(mesh, work_dir + out_dir + tile_dirlp + "AMP_Tile" + str(tt) + ".sus", actvMap*mrec)

# # Outputs
# PF.Magnetics.writeUBCobs(work_dir+out_dir + tile_dirlp + "AMP_Tile"+ str(tt) +"_Inv.pre", survey, invProb.dpred)
