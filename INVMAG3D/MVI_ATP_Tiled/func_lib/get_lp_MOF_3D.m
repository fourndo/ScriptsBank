function [MOF,aVRWs,aVRWx,aVRWy,aVRWz] = get_lp_MOF_3D(model,model_ref,phim,Ws,Wx,Wy,Wz,Gx,Gy,Gz,t,alpha,LP,FLAG1,FLAG2,FLAG3,delta_s,delta_xyz)
...
%     LP = LP(:,(1:5)+(jj-1)*5);
    ...
    switch FLAG2
        ...
        rs = sqrt( 1./ ( abs((m - mref)) .^2 + delta_s(jj).^2 ).^ (1 - pvec/2)  );
