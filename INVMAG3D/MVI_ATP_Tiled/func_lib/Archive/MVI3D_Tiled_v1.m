function [M,pred_TMI,beta_out,phid_out,MOF_out,switcher] = MVI3D_Tiled(work_dir,out_dir,dsep,idx,xn,yn,zn,H, HI, HD, obsx, obsy, obsz, Tx, Ty, Tz, d, wd,mstart,mref,esus,chi_target,phid_in,MOF_in,alphas,beta,bounds,LP,t,eps_FLAG,eps_tresh,switcher,FLAG1,FLAG2,max_iter)
