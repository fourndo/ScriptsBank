...
%         wr(1+2*mactv:3*mactv)= wr(1:mactv);%wr(1+2*mactv:3*mactv)/max(wr(1+2*mactv:3*mactv));
        ...
        phi_a = invmod(1:mactv)'*(Ws'*spdiags(wr(1:mactv),0,mactv,mactv)*Ws + Gx'*Wx'*spdiags(wr(1:mactv),0,mactv,mactv)*Wx*Gx + Gy'*Wy'*spdiags(wr(1:mactv),0,mactv,mactv)*Wy*Gy + Gz'*Wz'*spdiags(wr(1:mactv),0,mactv,mactv)*Wz*Gz)*invmod(1:mactv);
