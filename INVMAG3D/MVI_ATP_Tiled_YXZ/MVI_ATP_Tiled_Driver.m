...
%% RUN MAGNETIC VECTOR INVERSION (MVI)
    ...
    [M_xyz,beta_in] = MVI3D_PST_Tiled(tile_dir,out_dir,dsep,xn_t,yn_t,zn_t,H, HI,...
        ...
        chi_target,alphas,[],bounds_PST,kron([1 1 1],[2 2 2 2 1]),t,lp_tresh{1},...
        lp_tresh{2} ,FLAG1,FLAG2,100 );
    
    save([tile_dir dsep 'Tile' num2str(ii) '_MVI_pst_START.fld'],'-ascii','M_xyz')
