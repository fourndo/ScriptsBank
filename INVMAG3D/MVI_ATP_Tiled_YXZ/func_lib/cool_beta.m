function [arg_out,beta_out] = cool_beta( beta_in , phi_d , rdm, target , arg_in , tol, res_min)
...
if rdm < res_min && arg_in == 2 && phi_d < target * (1+tol) && phi_d > target * (1-tol)
