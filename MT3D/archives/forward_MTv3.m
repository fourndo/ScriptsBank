...
%% Create secondary gradient (center to face)
...
% 
% Ox = sparse (size(Avfx,1) , size(Avfx,2));
% Oy = sparse (size(Avfy,1) , size(Avfy,2));
% Oz = sparse (size(Avfz,1) , size(Avfz,2));
% 
% AVC = [Avfx Ox Ox;
%         Oy Avfy Oy 
%         Oz Oz Avfz];
