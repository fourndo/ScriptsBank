...
srclocA = np.c_[-750., 0., 0.]
srclocB = np.c_[750., 0., 0.]
...
m0 = np.log(np.ones_like(sigma)*1e-3)
...
updateWr = Directives.Update_DC_Wr(wrType=wrType, changeMref=changeMref, eps=1e-6)
...
mesh.writeUBC('MeshDC.msh',{'InvModel.con':expmap*mopt})
